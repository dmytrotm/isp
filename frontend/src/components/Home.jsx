import { Wifi as WifiIcon, Tv as TvIcon, Phone as PhoneIcon, Speed as SpeedIcon, LocalOffer as LocalOfferIcon, Info as InfoIcon, ArrowForward as ArrowForwardIcon } from '@mui/icons-material';
  ...
  useEffect(() => {
    const fetchServices = async () => {
      try {
        ...
        const servicesData = response.data.data?.results || response.data.results || response.data.data || response.data;
    ...
    if (selectedService) {
      const fetchTariffs = async () => {
        try {
          ...
          const tariffsData = response.data.data?.results || response.data.results || response.data.data || response.data;
          
          if (Array.isArray(tariffsData)) {
            // Filter only active tariffs
            const activeTariffs = tariffsData.filter(
