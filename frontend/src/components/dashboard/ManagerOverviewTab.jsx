...
export default function ManagerOverviewTab({ dashboardStats, setTabValue, paymentStatusData, getColorForSegment }) {
  ...
  return (
    <Grid container spacing={3}>
      ...
      <Grid size={{ xs: 12, md: 6 }}>
        <Card>
          <CardHeader title="Recent Support Tickets" action={<Button size="small" onClick={() => setTabValue(3)}>View All</Button>} />
          <List>
      ...
      <Grid size={{ xs: 12, md: 6 }}>
        <Card>
          <CardHeader title="Recent Connection Requests" action={<Button size="small" onClick={() => setTabValue(4)}>View All</Button>} />
          <List>
