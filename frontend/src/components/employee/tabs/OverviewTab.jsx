...
const OverviewTab = ({ dashboardStats, setTabValue }) => {
  ...
  const handleRefresh = async () => {
    try {
      ...
      const statsResponse = await api.get("/dashboard/manager/", {
        headers: {
                ...
                <React.Fragment key={ticket.id}>
                  <ListItem>
                    <ListItemText
                      ...
                      secondary={ticket.customer_details?.user_details?.full_name}
                    />
                    <Chip
                      size="small"
                      label={ticket.status}
            ...
            <List>
              {dashboardStats.recent_requests?.map((request, index) => (
                <React.Fragment key={request.id}>
                  <ListItem>
                    <ListItemText
                      primary={request.customer_details?.user_details?.full_name}
